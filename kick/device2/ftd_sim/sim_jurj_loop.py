...
process_command(10, '', 'ful01-n8-qp4110-2-A# ')
process_command(11, '', 'ful01-n8-qp4110-2-A# ')
process_command(12, 'connect module 1 console', """Telnet escape character is '~'.
Trying 127.5.1.1...
...
""" + '\a')
process_command(13, '\x15', 'ful01-n8-qp4110-1> ', True)
process_command(14, '', 'Firepower-module1> ', True)
process_command(15, '', 'Firepower-module1> ', True)
process_command(16, 'connect ftd', '> ')
